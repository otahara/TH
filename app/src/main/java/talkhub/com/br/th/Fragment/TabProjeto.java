...
public class TabProjeto extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        RecyclerView recyclerView = (RecyclerView) view.findViewById(R.id.recycleProjetos);
        ...
        final ProjetoListAdapter projetoListAdapter = new ProjetoListAdapter(projetos,getContext());
        recyclerView.setAdapter(projetoListAdapter);


        DatabaseReference mRefProjetosUsuario = FirebaseDatabase.getInstance().getReference().child("usuarios")
                .child(LoginActivity.idUsuario).child("projetos");

        mRefProjetosUsuario.addValueEventListener(new ValueEventListener() {
            @Override
            public void onDataChange(DataSnapshot dataSnapshot) {
                for(DataSnapshot item : dataSnapshot.getChildren()){
                    ...
                    projeto.setIdEquipe(item.child("idEquipe").getValue().toString());
